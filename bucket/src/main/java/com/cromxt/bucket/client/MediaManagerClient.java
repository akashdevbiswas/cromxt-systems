...
public class MediaManagerClient {
    ...
    public MediaManagerClient(WebClient.Builder webClientBuilder,
    ...
    public Mono<NewMediaResponseDTO> createMediaObject(NewMediaRequest newMediaRequest){
        String url = String.format("%s/%s",mediaClientBaseUrl);
        return webClient
                .post()
                .uri(URI.create(url))
